...
// Import the 'app' variable (Firebase initialization) from App.js
import { app } from './App'; 
...
const getStatusDetails = (room) => {
    ...
    // Use the capacity from Firebase, or default to 60.
    const capacity = room.capacity || 60; 
    const availableSeats = capacity - room.count;
    ...
    return { 
        ...
        availableSeats,
        isFull,
        capacity // Pass capacity to the render
    };
};

function RoomDetail() {
    // Get the room ID from the URL (e.g., '/details/C-013')
    ...
    }, [roomId]); // Re-run if the roomId changes
    ...
    const { occupancyStatus, statusColor, availableSeats, isFull, capacity } = getStatusDetails(roomData);
            ...
            <div className="detail-card">
                ...
                <div className="metrics-grid">
                    ...
                    <div className="metric-box">
                        ...
                        <span className="metric-value">{capacity}</span> 
